...
// // use serde_json;
// // use entity::user::{Vehicle, User, Data};
...
// // mod b {
// //     pub fn foo() {
// //         super::a::foo();  // here super represents mainui
// //     }
// // }
// const h:i32=9;
// fn main() {
...
// 
// 
// fn return_data(c:i32)->Option<String>{
//     if c>0 {
